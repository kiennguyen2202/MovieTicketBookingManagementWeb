...
namespace MovieTicketBookingManagementWeb.Migrations
{
    ...
    [Migration("20250408123353_MakePopcornDrinkItemIDNullable")]
    partial class MakePopcornDrinkItemIDNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieTicketBookingManagementWeb.Models.CartItem", b =>
                {
            ...
            modelBuilder.Entity("MovieTicketBookingManagementWeb.Models.PopcornDrinkCardItem", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CartItemShowtimeID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CartItemShowtimeID");

                    b.ToTable("PopcornDrinkCardItem");
                });
            ...
            modelBuilder.Entity("MovieTicketBookingManagementWeb.Models.CartItem", b =>
                {
                    b.HasOne("MovieTicketBookingManagementWeb.Models.Order", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("MovieTicketBookingManagementWeb.Models.PopcornDrinkCardItem", b =>
                {
                    b.HasOne("MovieTicketBookingManagementWeb.Models.CartItem", null)
                        .WithMany("PopcornDrinkCardItems")
                        .HasForeignKey("CartItemShowtimeID");
                });
            ...
            modelBuilder.Entity("MovieTicketBookingManagementWeb.Models.CartItem", b =>
                {
                    b.Navigation("PopcornDrinkCardItems");
                });
