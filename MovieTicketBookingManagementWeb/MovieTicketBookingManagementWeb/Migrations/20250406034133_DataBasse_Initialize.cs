...
{
    /// <inheritdoc />
    public partial class DataBasse_Initialize : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PopcornDrinkItems", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Orders__3214EC279F18DDF8", x => x.ID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PosterURL = table.Column<string>(type: "varchar(255)", unicode: false, maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PopcornDrinkItemID = table.Column<int>(type: "int", nullable: false),
                    PopcornQuantity = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__Tickets__PopcornDrinkItemID__XXXXXX",
                        column: x => x.PopcornDrinkItemID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderDet__3214EC277A369FC6", x => x.ID);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK__OrderDeta__Ticke__1BC821DD",
                        column: x => x.TicketID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_PopcornDrinkItemID",
                table: "OrderDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_PopcornDrinkItemID",
                table: "Tickets",
                column: "PopcornDrinkItemID");
